...
RC Stmt::create_stmt(Db *db, ParsedSqlNode &sql_node, Stmt *&stmt)
{
  ...
  switch (sql_node.flag) {
    ...
    case SCF_CREATE_TABLE_SELECT: {
      return CreateTableSelectStmt::create(db, sql_node.create_table, sql_node.selection, stmt);
    }

    case SCF_CREATE_VIEW: {
      return CreateViewStmt::create(db, sql_node.create_table, stmt, sql_node.selection);
    }
